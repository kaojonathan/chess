...
// XWindow constructor, allocate space for a pImpl. Creates a graphic window according to X11 standards.
...
// XWindow destructor, closes the graphic window and deallocates space.
XWindow::~XWindow()
{
