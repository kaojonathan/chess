...
class Player; // player
class Piece
{ // the piece class; manages the move logic, as well as some board logic
protected:
    std::vector<std::pair<int, int>> castle; // castle positions
...
public:
    Piece(int side, int x, int y, Board *); // constructor
